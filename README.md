...
4. **Class Activation Map**:
    - The CAM for class $c$ is computed as: $M_c(x, y) = \sum_{k} w_{k}^{c} f_k(x, y)$ 
...
![CAM Example](images/CAM_dogs.png)

There is another example of applying CAM to an image of a bird:

![CAM Example](images/CAM_bird.png)

Now let's see the difference of CAMs for different classes of images.

![CAM Example](images/CAM_vs_CAM_dogs.png)

![CAM Example](images/CAM_vs_CAM_bird.png)
...
![SeCAM Example](images/CAM_dogs.png)
![SeCAM Example](images/SeCAM_dogs.png)

There is another example of applying SeCAM to an image of a tiger:

![SeCAM Example](images/SeCAM_tiger.png)
